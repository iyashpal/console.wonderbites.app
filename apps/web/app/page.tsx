...
import { AuthPageCard } from '@/components/auth';
    ...
    return <>
        <AuthPageCard>
            ...
            <div className="flex flex-col items-center w-full pt-3 space-y-4">
                ...
                <Link href={'/forgot-password'} className="text-red-primary hover:underline transition-all ease-in-out duration-700">Forgot Password?</Link>
            </div>
        </AuthPageCard>
    </>
}