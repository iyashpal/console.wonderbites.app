        ...
        <FormCard title="Add Ingredient" onSubmit={form.onSubmit.create} backUrl="/app/ingredients" processing={form.isProcessing}>
          <div className="grid grid-cols-6 gap-6">
            ...
            <div className="col-span-6 sm:col-span-3">
              ...
              <input type="number" defaultValue={form.data.minQuantity} onChange={form.input.onChange.minQuantity} name="min-quantity" id="min-quantity" className="mt-1 block w-full  border border-gray-300 py-2 px-3 shadow-sm focus:border-red-500 focus:outline-none focus:ring-red-500 sm:text-sm" />
              <InputError error={form.errors?.price}>{form.errors.price}</InputError>
            </div>
