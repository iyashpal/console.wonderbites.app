      ...
      <div className="px-4 sm:px-6">
        ...
        <ul role="list" className="divide-y divide-gray-100">
          ...
          <li className="flex items-center justify-between gap-x-6 py-5">
            ...
            <div className="flex flex-none items-center gap-x-4">
              <button onClick={() => setShowVariable(true)} className="hidden rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:block">View<span className="sr-only">, New benefits plan</span></button>
            </div>
          </li>
          <li className="flex items-center justify-between gap-x-6 py-5">
            <div className="min-w-0">
            ...
            <div className="flex flex-none items-center gap-x-4">
              <button onClick={() => setShowVariable(true)} className="hidden rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:block">View<span className="sr-only">, Onboarding emails</span></button>
            </div>
          </li>
        </ul>
...
function CreateProductVariant({open, onClose}: { open: boolean, onClose: () => void }) {
  ...
  return (
    <Modal show={open} className={'max-w-3xl'}>
  ...
  return (
    <SlideOver.Wrapper open={open} onClose={onClose}>

      <SlideOver.Content title={'Create New'} description={'Add a variation to the product.'} onClose={onClose}>
        <div className="relative mt-6 flex-1 px-4 sm:px-6">
          ...
          <div className="grid grid-cols-6 gap-6">
            ...
            <div className="col-span-6">
              ...
              <textarea name="description" rows={9} id="description" autoComplete="description" className="mt-1 block w-full  border border-gray-300 py-2 px-3 shadow-sm focus:border-red-500 focus:outline-none focus:ring-red-500 sm:text-sm"></textarea>
              {/*<InputError error={form.errors?.description} />*/}
            </div>
      ...
      <SlideOver.Actions>
        <button onClick={onClose} type="button" className="rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:ring-gray-400">
          Cancel
        </button>
        <button type="submit" className="ml-4 inline-flex justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500">
          Save Variable
        </button>
      </SlideOver.Actions>
    </SlideOver.Wrapper>
